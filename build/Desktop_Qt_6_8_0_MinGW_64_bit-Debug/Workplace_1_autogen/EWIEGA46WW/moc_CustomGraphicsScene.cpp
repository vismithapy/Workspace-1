...
void CustomGraphicsScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->shapeDeleted((*reinterpret_cast< std::add_pointer_t<QGraphicsItem*>>(_a[1]))); break;
        case 1: _t->shapeResized((*reinterpret_cast< std::add_pointer_t<QGraphicsItem*>>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (CustomGraphicsScene::*)(QGraphicsItem * );
            if (_t _q_method = &CustomGraphicsScene::shapeDeleted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CustomGraphicsScene::*)(QGraphicsItem * );
            if (_t _q_method = &CustomGraphicsScene::shapeResized; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void CustomGraphicsScene::shapeDeleted(QGraphicsItem * _t1)
{
...
// SIGNAL 1
void CustomGraphicsScene::shapeResized(QGraphicsItem * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
